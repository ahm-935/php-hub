  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item  dropdown d-none d-md-block">
        <a class="nav-link dropdown-toggle" id="reportDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          Reports </a>
      ...
      <li class="nav-item nav-language dropdown d-none d-md-block">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
          ...
          <a class="dropdown-item" href="#">
            <div class="nav-language-icon mr-2">
              <i class="flag-icon flag-icon-bd" title="BD" id="bd"></i>
            </div>
            <div class="nav-language-text">
      ...
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          ...
          <div class="nav-profile-text">
            <p class="mb-1 text-black">A H Munna</p>
          </div>
        </a>
        <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm"
          aria-labelledby="profileDropdown" data-x-placement="bottom-end">
          <div class="p-3 text-center bg-primary">
            <img class="img-avatar img-avatar48 img-avatar-thumb" src="assets/images/faces/arif.png" alt="">
          </div>
          <div class="p-2">
